...
Route::group(['middleware' => ['role_admin']], function () {
    ...
    Route::get('them_cv', 'BaocaoController@them_cv');
...
//    Route::get('baocao/gui_bao_cao', 'BaocaoController@gui_bao_cao');
    ...
    Route::get('baocao/thong_ke_van_ban_noi_bo/don_vi', 'BaocaoController@baoCaoThongKeDonVi_vbnoibo')->name('baocaothongke.vbnoibodonvi');
    Route::get('baocao/thong_ke_van_ban_noi_bo/ca_nhan', 'BaocaoController@baoCaoThongKeCaNhan_vbnoibo')->name('baocaothongke.vbnoibocanhan');
    Route::get('baocao/xem_thong_ke_van_ban_noi_bo', 'BaocaoController@xemBaoCaoThongKe_vbnoibo')->name('baocaothongke.vbnoibodanhsach');

    Route::get('quan-ly-tien-do', 'progressManageController@danhsachTienDoCV')->name('quanlytiendo.danhsach');
    Route::get('thong-ke-tien-do-cong-viec', 'progressManageController@thongke_tiendo')->name('quanlytiendo.thongke_tiendo');
    Route::post('import_update_bang_theo_doi_tien_do_cong_viec', 'progressManageController@import_update_bang_theo_doi_tien_do_cong_viec')->name('import_update_bang_theo_doi_tien_do_cong_viec');
    Route::post('process_import_ds_tiendo', 'progressManageController@process_import_ds_tiendo')->name('process_import_ds_tiendo');
    Route::get('sua-tien-do/{tiendoId}', 'progressManageController@edit_quan_ly_tien_do')->name('editquanlytiendo');
    Route::post('save-cap-nhat-tien-do-cong-viec', 'progressManageController@save_cap_nhat_tien_do')->name('quanlytiendo.savechinhsua');
    Route::post('xoa-tien-do-cong-viec', 'progressManageController@xoa_tien_do')->name('quanlytiendo.xoatiendocongviec');
    Route::post('loai-bo-tien-do-cong-viec', 'progressManageController@loai_bo_tien_do')->name('quanlytiendo.loaitiendocongviec');
    Route::post('cap-nhat-trang-thai-tien-do-cong-viec', 'progressManageController@cap_nhat_trang_thai')->name('quanlytiendo.cap_nhat_trang_thai');
    Route::get('them-moi-tien-do-cong-viec', 'progressManageController@them_moi_tien_do_cong_viec')->name('quanlytiendo.themmoi');
    Route::post('luu-them-moi-tien-do-cong-viec', 'progressManageController@luu_them_moi_tien_do_cong_viec')->name('quanlytiendo.luuthemmoi');
    ...
    Route::get('sua-phong-hop/{id}', 'PhongHopController@suaPhongHop')->name('phonghop.suaPhongHop');
    Route::post('cap_nhat_phong_hop', 'PhongHopController@cap_nhat_phong_hop')->name('phonghop.capNhatPhongHop');
    ...
    // Route::get('xoa-dang-ky-lich-tuan/{lichtuanId}', 'PhongHopController@xoa_dang_ky_lich_tuan');
    Route::post('thuhoilichtuan', [
        'as' => 'phonghop.thuhoilichtuan',
        'uses' => 'PhongHopController@thuhoilichtuan'
    ]);
    ...
    Route::group(['prefix' => 'congviec'], function () {
        ...
        Route::get('them_cv','CongviecController@them_cv')->name('congviec.them_cv');
    ...
    Route::group(['prefix' => 'congviec_chitiet'], function () {
        ...
        Route::post('giahancongviec','CongviecChiTietController@giahancongviec');
    });
    ...
    Route::group(['prefix'=>'vanban'],function(){
        ...
        Route::post('thuhoivanban', [
            'as' => 'vanban.thuhoivanban',
            'uses' => 'VanbanController@thuhoivanban'
        ]);
...
//        Route::get('send-mail-vb-chua-xu-ly','VanbanController@send_mail_van_ban_chua_xu_ly');
    ...
    Route::post('xoa-tai-khoan', 'UserController@xoa_tai_khoan')->name('xoa_tai_khoan'); 
...
Route::get('thong_ke_van_ban_den', 'BaocaoController@thongKeVBDen')->name('thongke.vanbanden');
Route::get('thong_ke_van_ban_den_ca_nhan', 'BaocaoController@thongKeVBDenCaNhan')->name('thongke.vanbandencanhan');
Route::get('thong_ke_van_ban_di', 'BaocaoController@thongKeVBDi')->name('thongke.vanbandi');
Route::get('thong_ke_van_ban_di_list', 'BaocaoController@thongKeVBDiList')->name('thongke.vanbandicanhan');
Route::get('thongke/xem_thong_ke_van_ban_di', 'BaocaoController@xemBaoCaoThongKeVBDi')->name('thongke.vanbandi.danhsach');
Route::get('thong_ke_van_ban_noi_bo', 'BaocaoController@thongKeVBNoiBo')->name('thongke.vanbannoibo');
Route::get('thong_ke_van_ban_noi_bo_ca_nhan', 'BaocaoController@thongKeVBNoiBoCaNhan')->name('thongke.vanbannoibocanhan');

Route::get('vanban/send-mail-vb-chua-xu-ly','VanbanController@send_mail_van_ban_chua_xu_ly');
...
Route::group(['prefix' => 'api'], function () {
    Route::get('get-lich-tuan', 'ApiController@getLichNgayByUser')->name('api.get_lich_tuan');
});
...
//start quan ly don vi
Route::group(['prefix' => 'quanlydonvi'], function () {
Route::get('quan-ly-don-vi', 'BookController@quan_ly_don_vi')->name('quan_ly_don_vi');
Route::get('don-vi/list-user', 'BookController@getListUser')->name('getListUser');
Route::post('them_can_bo', 'BookController@them_can_bo_vao_book')->name('them_can_bo_vao_book');
Route::post('cap_nhat_vi_tri', 'BookController@cap_nhat_vi_tri_can_bo')->name('cap_nhat_vi_tri_can_bo');
Route::get('danh-sach-nguoi-dung-loai-vb', 'BookController@ds_nguoi_dung_loai_vb')->name('ds_nguoi_dung_loai_vb');
Route::get('xem-ds-canbo/{book_id}/{donvi_id}', 'BookController@xemdanhsach_cb')->name('xemdanhsach_cb');
Route::post('xoa-can-bo','BookController@xoa_can_bo')->name('xoa_can_bo');
Route::get('them-don-vi', 'BookController@them_don_vi')->name('them_don_vi');
Route::post('luu-don-vi', 'BookController@luu_don_vi')->name('luu_don_vi');
Route::post('xoa-don-vi','BookController@xoa_don_vi')->name('xoa_don_vi');
Route::get('sua-don-vi/{donviId}', 'BookController@sua_don_vi')->name('sua_don_vi');
Route::post('cap-nhat-don-vi', 'BookController@cap_nhat_don_vi')->name('cap_nhat_don_vi');
Route::get('chi-tiet-don-vi/{donviId}', 'VanBanNoiBoController@chi_tiec');
});
