...
class BlogFrontController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        return view(config('app.interface').'front.blog.index', compact('posts'));
    }
    /**
    ...
    public function show(Request $request, $slug)
    {
        ...
        return view(config('app.interface').'front.blog.show', array_merge($this->blogRepository->getPostBySlug($slug), compact('user')));
    }
    ...
    public function tag(Request $request)
    {
        ...
        return view(config('app.interface').'front.blog.index', compact('posts', 'links', 'info'));
    }
    ...
    {
        return view(config('app.interface').'front.blog.test');
    }
}
