...
class CommonController extends Controller
{
    ...
    public function load_user_donviden_checkbox(Request $request) {
       ...
       // get bookdetail được chọn
        ...
        if ($request->chuyenvanban){
            $users = User::getList()->whereIn('users.id', $userIds)->get()->keyBy('id');
        }else{
        ...
        // return view
        return view(config('app.interface').'vanban._checkbox_user', compact('data', 'checkboxName', 'selectedUserIds'));
    }
