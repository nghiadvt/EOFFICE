...
class CongviecFileController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view(config('app.interface').'congviecs.congviecFile', compact($congviec));
    ...
    public function show()
    {
        ...
        return view(config('app.interface').'tabs.congviecfile', compact($files));
    }
    ...
    public function update(Request $request)
    {
        ...
        return view(config('app.interface').'congviecs.them-cv', compact($congviecFile));
    }
