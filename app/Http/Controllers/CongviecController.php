...
class CongviecController extends Controller
{
    ...
    public function fullcalendar(){
        ...
        return view(config('app.interface').'congviecs.fullcalendar',compact('congviec_users','congviecs'));
    }
    ...
    public function getUser_Unit(Request $request){
        ...
        return view(config('app.interface').'congviecs._getUser_Unit',compact('resultUsers','check_user','users','user_logged_username','select_donvi_of_supervisor'));
    }

    public function sua_congviec(Request $request){
        $congviec_id = $request->congviec_id;
        $congviec = CongViec::find($congviec_id);
        return view(config('app.interface').'congviecs.sua_congviec',compact('congviec'));
    }
    ...
    public function get_view_change_status(Request $request) {
        ...
        return view(config('app.interface').'congviecs._change_status', compact('congviec'));
    }
    ...
    public function view_Work(Request $request){
        ...
        return view(config('app.interface').'congviecs.view_work',compact('check_CheckUser','user','date_star','date_end','congviec_users','congviecs'));
    }

    public function view_dailyReport(Request $request){
        $report_id = $request->report_id;
        $dailyReport = DailyReport::find($report_id);
        return view(config('app.interface').'baocaos._modal_view_dailyReport',compact('dailyReport'));
    }
    ...
    public function view_report_detail(Request $request){
        ...
        return view(config('app.interface').'baocaos._modal_agreement_report',compact('congviec_baocao','view_report_detail'));
    }
    ...
    public function get_danh_sach_cong_viec($params = []) {
        ...
        $trangthai =  isset($params['status'])? $params['status'] : Input::get('status');
        ...
        if ($getView) {
            return view(config('app.interface').'congviecs._table_congviec', compact('congviecs', 'congviecIdActive'));
        }
        else {
            return $congviecs;
        }
