...
class BlogController extends Controller
{
    ...
    */
    ...
    public function indexOrder(Request $request)
    {
        ...
        if ($request->ajax()) {
            return [
                'view' => view(config('app.interface').'back.blog.table', compact('statut', 'posts'))->render(),
        ...
        return view(config('app.interface').'back.blog.index', compact('posts', 'links', 'order'));
    }
    ...
    {
        return view(config('app.interface').'back.blog.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view(config('app.interface').'back.blog.edit', $this->blogRepository->getPostWithTags($post));
    }
