...
class VanBanNoiBoController extends Controller
{
    public function danh_sach() {
        ...
        return view(config('app.interface').'vanbannoibo.danh_sach', compact('title','type', 'status', 'linhvucs', 'loaivanbans', 'vanbans'));
    }
    ...
    public function chi_tiec($id) {
        ...
        return view(config('app.interface').'vanbannoibo.chi_tiet', compact(
    ...
    public function nhap_vanban_noibo() {
        ...
        return view(config('app.interface').'vanbannoibo.nhap_vanban_noibo', compact('donvis', 'linhvucs', 'loaivanbans', 'sovanbandens', 'bookDetails', 'vanban'));
    }
    ...
    public function sua_vanban_noibo($vanbanId) {
        ...
        return view(config('app.interface').'vanbannoibo.sua_vanban_noibo', compact('donvis', 'linhvucs', 'loaivanbans', 'sovanbandens', 'bookDetails', 'vanban', 'userChuTris', 'userPhoiHops', 'userChuTriDaXemVanBanIds', 'userPhoiHopDaXemVanBanIds', 'donviPhoiHopDaXemVanBanIds', 'userTrongDonViPhoiHops'));
    }
    ...
    public function luu_sua_vanban_noibo(Request $request) {
        ...
        if ($request->hasFile('files')) {
            ...
            // check file type
            foreach ($files as $file) {
				if (!in_array($file->getClientOriginalExtension(), ['doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'pdf', 'zip'])) {
                    flash('File đính kèm không đúng định dạng');
                    return redirect()->back();
                }
            }
    ...
    public function chuyen_xu_ly($id) {
        ...
        return view(config('app.interface').'vanbannoibo.chuyen_xu_ly_van_ban', compact('vanbanden', 'book_detail', 'IdVanBanUser','arrIdUser','dataTreeview', 'userChuTris', 'donviPhoihops', 'userPhoihops'));
    }
