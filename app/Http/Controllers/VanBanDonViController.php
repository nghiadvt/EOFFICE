...
class VanBanDonViController extends Controller
{
    public function addVanBanDen()
    {
        ...
        return view(config('app.interface').'vanbandonvi.nhap_van_ban_den', compact('donvis', 'linhvucs', 'loaivanbans', 'publishs', 'sovanbandens', 'donvichons', 'dataTreeview'));
    }
    ...
    public function edit_vanban($vanbanId) {
        ...
        return view(config('app.interface').'vanbandonvi.edit_van_ban_den', compact('donvis', 'linhvucs', 'loaivanbans', 'publishs', 'sovanbandens', 'donvichons', 'vanban', 'userChuTris', 'userPhoiHops', 'userChuTriDaXemVanBanIds', 'userPhoiHopDaXemVanBanIds', 'donviPhoiHopDaXemVanBanIds', 'userTrongDonViPhoiHops'));
    }
    ...
    public function edit_vanban_di($vanbanId) {
        ...
        return view(config('app.interface').'vanbandonvi.edit_van_ban_di', compact('loaivanbans', 'donvischa', 'donviIds', 'linhvucs', 'bookDetails', 'vanban'));
        return view(config('app.interface').'vanbandonvi.edit_van_ban_den', compact('donvis', 'linhvucs', 'loaivanbans', 'publishs', 'sovanbandens', 'bookDetails', 'vanban', 'userChuTris', 'userPhoiHops', 'userChuTriDaXemVanBanIds', 'userPhoiHopDaXemVanBanIds', 'donviPhoiHopDaXemVanBanIds', 'userTrongDonViPhoiHops'));
    }
    ...
    public function getUser()
    {
        ...
        return view(config('app.interface').'vanbandonvi.ajax_user', compact('users'));
    }
    ...
    public function dsVanbanden(Request $request)
    {
        ...
        return view(config('app.interface').'vanbandonvi.danh_sach_van_ban_den', compact('status', 'linhvucs', 'loaivanbans', 'vanbans'));
    }
    ...
    public function van_ban_den_xu_ly()
    {
        ...
        return view(config('app.interface').'vanbandonvi.van_ban_den_xu_ly', compact('vanbanxulys'));
    }
    ...
    public function vanbandendagui()
    {
        ...
        return view(config('app.interface').'vanbandonvi.danh_sach_van_ban_den_da_gui', compact('lists', 'ds_vanbans', 'publishs', 'donvis', 'linhvucs', 'loaivanbans', 'book_detail'));
    }
    ...
    public function dsVanbandi(Request $request)
    {
        ...
        return view(config('app.interface').'vanbandonvi.danh_sach_van_ban_di', compact('vanbans', 'publishs', 'donvis', 'linhvucs', 'loaivanbans', 'donviGuiMails'));
    }
    ...
    public function VanBanDi()
    {
        ...
        return view(config('app.interface').'vanbandonvi.nhap_van_ban_di', compact('loaivanbans', 'donvischa', 'donviIds', 'linhvucs', 'bookDetails'));
    }
    ...
    public function settingUnit()
    {
        ...
        if ($role['role'] == 1) {
            ...
            $users = User::all();
            $books = Book::all();
            return view(config('app.interface').'vanbandonvi.cau_hinh_don_vi_nhan', compact('donvischa', 'linhvucs', 'loaivanbans', 'publishs', 'donvis', 'users', 'books'));
        } else {
            return view(config('app.interface').'vanbandonvi.test');
        }
    ...
    public function detailVanbanden($id) {
        ...
        return view(config('app.interface').'vanbandonvi.chi_tiet_van_ban_den', compact(
            'tab', 'vbxuly', 
    ...
    public function chi_tiet_van_ban_di($vanbanId) {
        ...
        return view(config('app.interface').'vanbandonvi.chi_tiet_van_ban_di', compact('vanban'));
    }
    ...
    public function chi_tiet_van_ban_den_da_gui($id)
    {
        ...
        return view(config('app.interface').'vanbandonvi.chi_tiet_van_ban_den_da_gui', compact('vanbanden', 'user'));
    ...
    public function dsVanbanluu()
    {
        ...
        return view(config('app.interface').'vanbandonvi.van_ban_luu', compact('lists', 'donvis', 'publishs'));
    }

    public function detailVanbanluu($id)
    {
        $vanbanden = VanbanDonvi::find($id);
        return view(config('app.interface').'vanbandonvi.chi_tiet_van_ban_den', compact('vanbanden'));
    }
    ...
    public function editVanbanluu($id)
    {
        ...
        return view(config('app.interface').'vanbandonvi.edit_van_ban_luu', compact('donvis', 'linhvucs', 'loaivanbans', 'publishs', 'book_detail', 'vanbans'));
    }
    ...
    public function edit_van_ban_da_gui($id)
    {
        ...
        return view(config('app.interface').'vanbandonvi.edit_van_ban_da_gui', compact('donvis', 'linhvucs', 'loaivanbans', 'publishs', 'book_detail', 'vanbans', 'userid', 'arrDv'));
    }
    ...
    public function gui_but_phe_van_ban_den($id)
    {
        ...
        return view(config('app.interface').'vanbandonvi.gui_but_phe_van_ban_den', compact('vanbanden', 'book_detail'));
    }
    ...
    public function view_log($IdVanBanUser)
    {
        $dataLog = Log::select('vanbans_donvi.cq_banhanh', 'vanbans_donvi.title', 'vanbans_donvi.file_dinhkem', 'vanbans_donvi.ngaygui', 'vanbans_donvi.hanxuly', 'logs.*', 'tbDonViNhan.name as tenDonViNhan', 'tbDviBanHanh.name as tenDViBanHanh')
            ...
            ->leftJoin('donvis as tbDviBanHanh', 'tbDviBanHanh.id', '=', 'vanbans_donvi.cq_banhanh')
            ->get();
        return view(config('app.interface').'vanbandonvi.view_log', compact('dataLog'));
    }
    ...
    public function chuyen_xu_ly_van_ban($id)
    {
        ...
        return view(config('app.interface').'vanbandonvi.chuyen_xu_ly_van_ban', compact('vanbanden', 'book_detail', 'IdVanBanUser','arrIdUser','dataTreeview', 'userChuTris', 'donviPhoihops', 'userPhoihops'));
    }
    ...
    public function quy_trinh_chuyen_tiep()
    {
        ...
        return view(config('app.interface').'vanbandonvi.quy_trinh_chuyen_tiep', compact('vanBanXuLy', 'vb_child'));
    }
    ...
    public function xu_ly_van_ban_user()
    {
        ...
        return view(config('app.interface').'vanbandonvi.xu_ly_van_ban_user', compact('id_vanbanuser', 'id'));
    }
    ...
    public function check_xu_ly_vanban() {
        ...
        if (!$vanbanxuly) {
            return view(config('app.interface').'vanbandonvi._form_check_status_vanban', compact('vanbanxuly'));
        }
        ...
        return view(config('app.interface').'vanbandonvi._form_check_status_vanban', compact('vanbanxuly', 'check'));
    }
    ...
    public function nhap_vanban_banhanh() {
        ...
        return view(config('app.interface').'vanbandonvi.form_van_ban_banhanh', compact('donvis'));
    }
    ...
    public function sua_vanban_banhanh($vanbanbanhanhId) {
        ...
        return view(config('app.interface').'vanbandonvi.form_van_ban_banhanh', compact('donvis', 'vanbanBanhanh', 'userNhanIdsArr', 'usersInDonvi'));
    }
    ...
    public function danhsach_vanban_banhanh() {
        ...
        return view(config('app.interface').'vanbandonvi.danh_sach_van_ban_ban_hanh', compact('vanbans', 'users','donvis', 'type'));
    }
