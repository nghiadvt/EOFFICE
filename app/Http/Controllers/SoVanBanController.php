...
class SoVanBanController extends Controller
{
    public function get_danh_sach() {
        ...
        return view(config('app.interface').'sovanban.danh_sach_so_van_ban', compact('sovanbans'));
    }
    ...
    public function get_danh_sach_van_ban_thuoc_so($sovanbanId) {
        ...
        // dd($vanbans->toArray());
        return view(config('app.interface').'sovanban.danh_sach_van_ban_thuoc_so', compact('vanbans'));
    }

    public function create_so_van_ban() {
        return view(config('app.interface').'sovanban.create_so_van_ban');
    }
    ...
    public function edit_so_van_ban($id) {
        ...
        // view
        return view(config('app.interface').'sovanban.edit_so_van_ban', compact('soVanBan'));   
    }
