        ...
        <div class="row group-function mx-0">
            <div class="col-md-10 offset-sx-12 breadcrumbs mx-0 px-0">
                <div class="breadcrumbs-link">
                    ...
                    <div><img src="{{ asset('img/assets/icon/expand_right.png') }}" class="img-expand"></div>
                    <div><a href="" class="txt-link">Chỉnh sửa tài khoản</a></div>
                </div>
            </div>
        </div>
        <div class="container">
                ...
                <div class="col-sm-12 table-bordered" style="margin-top: 20px">
                    <form id="TaikhoanForm" action="{{ route('save_tai_khoan') }}" class="form-input" method="POST">
                        <div class="form-row">
                            ...
                            <div class="form-row">
                                <div style="text-align: center; margin-top: 20px; font-size : 25px !important; color: var(--website-dark-mode-4284-d-2, #4284D2); ">Chỉnh sửa tài khoản</div>
                                ...
                                <div class="form-item " style="padding-top : 10px">
                                    ...
                                    <div class="form-item-checkbox">
                                        <input value="{{ $user->fullname }}" type="text" name="fullname" class="form-control" style="width: 498px; margin-left: 19px" placeholder="Nhập họ và tên">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12 vanban">
                                <div class="form-item ">
                                    ...
                                    <div class="form-item-checkbox">
                                        <input type="text" name="macanbo" class="form-control" style="width: 498px; margin-left: 15px" placeholder="Nhập mã cán bộ" value="{{ $user->macanbo }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 vanban">
                                <div class="form-item ">
                                    ...
                                    <div class="form-item-checkbox"  >
                                        <input type="text" name="email" class="form-control" style=" margin-left: 50px; width: 497px " placeholder="Nhập email cho tài khoản" value="{{ $user->email }}"> 
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 vanban">
                                <div class="form-item ">
                                    ...
                                    <div class="form-item-checkbox">
                                        ...
                                        width: 495px;" placeholder="Nhập email đăng nhập" value="{{ $user->azure_id }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 vanban">
                                <div class="form-item ">
                                    ...
                                    <div class="form-item-checkbox">
                                        ...
                                        margin-left: 17px" placeholder="Nhập vào chức danh" value="{{ $user->chucdanh }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 vanban" style="display:{{$user->role == 3 ? '' : 'none'}}; padding-top: 18px" id="lichtuan_lanhdao">
                                <div class="form-item ">
                                    ...
                                    <div class="form-item-c">
                                        ...
                                        <input style=" display: flex !important;  margin-left: 30px; margin-top: -12px"
                                            type="checkbox" {{ ($user->lanhdao? 'checked' : '') }} name="lanhdao">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" vanban">
                                <div class="form-item">
                                    ...
                                    <div class="form-item-c">
                                        <input type="checkbox"  name="duyetlichtuan" {{ ($user->duyetlichtuan? 'checked' : '') }} style="margin-top: -15x;display: flex !important; margin-left:58px">
                                    </div>
                                </div>
                            </div>
