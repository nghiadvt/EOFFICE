...
@include(config('app.interface').'templates.menu')
        ...
        <div class="bg-light border-right " id="sidebar-wrapper">
                ...
                <ul id="menu-hlavni-menu" class="" style="list-style-type: none;padding: 0;">
                    ...
                    <li id="menu-item-61" class="parent-notifi menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-has-children menu-item-61">
                        ...
                        <ul class="sub-menu {{ strpos($curUrl, 'vanbannoibo') !== false? 'dp_block' : '' }}" style="list-style-type: none;padding: 0;">
                            ...
                            <li id="menu-item-74" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-74">
                                <a class="list-group-item list-group-item-action bg-light {{ (strpos($curUrl, 'vanbannoibo/sua') !== false || $curUrl == 'vanbannoibo/danh-sach-gui') ? 'active' : '' }}" title="Danh sách văn bản đến" href="{{ url('vanbannoibo/danh-sach-gui?type=gui') }}">
                                    <div id="sidebar_icon">
                                        <i class="fa fa-file-text" aria-hidden="true"></i>
                                    </div>
                                    <div id="postt">
                            ...
                            <li id="menu-item-74" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-74">
                                <a class="list-group-item list-group-item-action bg-light {{ $curUrl == 'vanbannoibo/danh-sach-nhan' ? 'active' : '' }}" title="Danh sách văn bản đến" href="{{ url('vanbannoibo/danh-sach-nhan?type=nhan') }}">
                                    <div id="sidebar_icon">
                                        <i class="fa fa-file-text" aria-hidden="true"></i>
                                    </div>
                                    <div id="postt">
                    ...
                    @if($user->role == 4 || $user->role==5) <!-- 4:Admin, 5:Manager -->
                        <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-has-children">
                            <a class="list-group-item list-group-item-action bg-light {{ $curUrl == 'danh_sach_phong_hop'? 'active' : '' }}"
                               title="Danh sách phòng họp" href="{{ route('phonghop.danhsachphonghop') }}">
                                <div id="postt">Danh sách phòng họp</div>
                            </a>
                        </li>
                    @endif
                    <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-has-children">
                        <a class="list-group-item list-group-item-action bg-light {{ $curUrl == 'quan-ly-tien-do' || $curUrl == 'them-moi-tien-do-cong-viec' || strpos($curUrl, 'sua-tien-do') !== false ? 'active' : '' }}"
                           title="Danh sách phòng họp" href="{{ route('quanlytiendo.danhsach') }}">
                            <div id="postt">Quản lý tiến độ</div>
                        </a>
                    </li>

                    <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-has-children">
                        <a class="list-group-item list-group-item-action bg-light {{ $curUrl == 'thong-ke-tien-do-cong-viec' ? 'active' : '' }}"
                           title="Danh sách phòng họp" href="{{ route('quanlytiendo.thongke_tiendo') }}">
                            <div id="postt">Thống kê tiến độ công việc</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-has-children">
                        <a class="list-group-item list-group-item-action bg-light">
                            <div id="postt">
                                Thống kê văn bản <i class="fa fa-sort-desc fr" aria-hidden="true"></i>
                            </div>
                        </a>
                        <ul class="sub-menu {{ in_array($curUrl, ['thong_ke_van_ban_den', 'thong_ke_van_ban_den_ca_nhan', 'thong_ke_van_ban_noi_bo', 'thong_ke_van_ban_noi_bo_ca_nhan', 'thong_ke_van_ban_di', 'thong_ke_van_ban_di_list'])? 'dp_block' : '' }}"
                            style="list-style-type: none;padding: 0;">
                            <li id="menu-item-77"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-77">
                                <a class="list-group-item list-group-item-action bg-light {{ $curUrl == 'thong_ke_van_ban_den' || $curUrl == 'thong_ke_van_ban_den_ca_nhan' ? 'active' : '' }}"
                                    title="Văn bản đến" href="{{route('thongke.vanbanden')}}">
                                    <div id="sidebar_icon">
                                        <i class="fa fa-area-chart" aria-hidden="true"></i>
                                    </div>
                                    <div id="postt">
                                ...
                                <a class="list-group-item list-group-item-action bg-light {{ $curUrl == 'thong_ke_van_ban_di' || $curUrl == 'thong_ke_van_ban_di_list' ? 'active' : '' }}"
                                   title="Danh sách văn bản đi" href="{{route('thongke.vanbandi')}}">
                                    <div id="sidebar_icon">
                                        <i class="fa fa-area-chart" aria-hidden="true"></i>
                                    </div>
                                    <div id="postt">Văn bản đi</div>
                                </a>
                                @if (isset($user->view_thongke) && $user->view_thongke === 1)
                                    <a class="list-group-item list-group-item-action bg-light {{ $curUrl == 'thong_ke_van_ban_noi_bo' || $curUrl == 'thong_ke_van_ban_noi_bo_ca_nhan' ? 'active' : '' }}"
                                       title="Danh sách văn bản đi" href="{{route('thongke.vanbannoibo')}}">
                                        <div id="sidebar_icon">
                                            <i class="fa fa-area-chart" aria-hidden="true"></i>
                                        </div>
                                        <div id="postt">Văn bản nội bộ</div>
                                    </a>
                                @endif
                            </li>
                        </ul>
            ...
            @if ($user->role == $userRoles['admin'])
                ...
                <div class="list-group list-group-flush">
                    <ul id="menu-hlavni-menu" class="" style="list-style-type: none;padding: 0;">
                        ...
                        <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-has-children">
                            <a class="list-group-item list-group-item-action bg-light {{ $curUrl == 'quan_ly_don_vi'? 'active' : '' }}"
                               title="Quản lý đơn vị" href="{{ route('quan_ly_don_vi') }}">
                                <div id="sidebar_icon">
                                    <i class="fa fa-user"></i>
                                </div>
                                <div id="postt">Quản lý đơn vị</div>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="list-group list-group-flush">
                <ul id="menu-hlavni-menu" class="" style="list-style-type: none;padding: 0;">
                    ...
                    <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-has-children">
                        <a class="list-group-item list-group-item-action bg-light {{ $curUrl == 'import-luong'? 'active' : '' }}"
...
@include(config('app.interface').'partials._loading')
