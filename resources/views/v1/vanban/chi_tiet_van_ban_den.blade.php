        ...
        <div id="exTab1">
            ...
            <div class="tab-content clearfix">
                    ...
                    <div class="row">
                        ...
                        <div class="pull-right btn-custom" style="display: flex">
                            ...
                            @if ($vanbanden->user_id == session('user')['id'])
                                <a class=" btn btn-primary mg-l10" href="{{route('edit_vanban', $vanbanden->id)}}" title="Sửa văn bản"><i class="fa fa-eraser" aria-hidden="true"> Sửa văn bản</i></a>
                                @if($vanbanden->publish_id != 5)
                                <a class=" btn btn-primary mg-l10" href="javascript:;" onclick="showModalGuiLaiMail()" title="Gửi lại mail"><i class="fa fa-envelope-o" aria-hidden="true"> Gửi lại mail</i></a>
                                @endif
                            @endif
                            @if($vanbanden->publish_id != 5)
                                <a class=" btn btn-primary mg-l10" href="{{route('chuyen_xu_ly_van_ban', $vanbanden->id)}}" title="Chuyển xử lý văn bản"><i class="fa fa-paper-plane-o" aria-hidden="true"> Chuyển xử lý văn bản</i></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($vanbanden->publish_id != 5)
                                            ...
                                            <?php }?>
                                        @else
                                            <span class="doNotAction">Chỉ xem</span>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="tab-pane {{ $tab == 2? 'active' : '' }}" id="3a">
                    <div class="pull-left" style="margin-bottom: 18px;"><div style="font-size: 17px;background: yellow;margin-top: 10px;"><i class="fa fa-tag"></i> Văn bản đến</div></div>
                    @include(config('app.interface').'vanban.chi_tiet_van_ban_den_tab_y_kiens', ['vbxuly' => $vbxuly])
                </div>
                <div class="tab-pane {{ $tab == 3? 'active' : '' }}" id="4a">
                    ...
                    @include(config('app.interface').'congviecs._danh_sach_cong_viec', ['vanbanxuly' => $vanBanXuLy])
                </div>
            </div>
        </div>
    </div>
