             ...
             <table class="table table-bordered">
                <thead class="head-table">
                    <tr>
                        ...
                        <th>Số đến</th>
                        <th>Loại văn bản</th>
                        <th class="mw-dvchutri">Đơn vị chủ trì</th>
                        @if($status == 'ganhethan')
                            <th>Người nhận</th>
                        @endif
                        <th>Số ký hiệu</th>
                        <th>Ngày ban hành</th>
                        <th class="mw-trichyeu">Trích yếu</th>
                        <th>Hạn xử lý</th>
                        <th>Trạng thái</th>
                        <th>File</th>
                ...
                @if(sizeof($vanbans))
                    ...
                    @foreach ($vanbans as $val)
                        <tr>
                            ...
                            @if($status == 'ganhethan')
                                <td>{{$val->userNhan->fullname? $val->userNhan->fullname : ''}}</td>
                            @endif
                            <td>
                            ...
                            <td class="text-center">
                                ...
                                <span style="padding:5px 10px;cursor: pointer;"><a onclick="thuHoiVanBan({{$val->vanbanUser_id}})" title="Xem chi tiết"><i class="text-danger fa fa-window-close-o"> </i></a></span>
                                @endif
                            </td>
                        </tr>
                    @endforeach
