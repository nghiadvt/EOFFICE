                    ...
                    <div class="col-md-12 vanban">
                        ...
                        <div class="col-sm-6" style="padding-left: 0;">
                            <div class="form-item">
                                ...
                                <div class="form-item-c">
                                    <input type="text" class="form-control" name="hanxuly" id="hanxuly" value="{{ $vanban->hanxuly ? formatdmYY($vanban->hanxuly ) : '' }}" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 vanban">
                        <div class="form-item">
                            ...
                            <div class="form-item-c">
                                <div class="row">
                                    <div class="col-md-3">
                                        <input type="file" name="files[]" multiple class="btn btn-success" accept=".doc,.docx,.xls,.xlsx,.ppt,.pptx,.pdf,.zip" style="width: 100%;text-align: left;">
                                        <span style="color: red;">Đính kèm file mới sẽ thay các file đính kèm cũ</span>
                                    </div>
                                    <div class="col-md-9">
                                        <p style="padding-top:7px;"><i>Chỉ cho upload định dạng file: <span style="color: green;">doc, docx, xls, xlsx, ppt, pptx, pdf, zip</span> với dung lượng < 20M</i></p>
                                    </div>
                                </div>
                            </div>
                        </div>
