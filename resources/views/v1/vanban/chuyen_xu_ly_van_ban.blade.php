...
@section('main')
            ...
            <form action="{{route('luu_xu_ly_van_ban')}}" id="xulyvanban" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-md-12 treeview table-bordered " style="margin-top: 20px">
                        <div class="form">
                            @if($vanbanxuly->type == 1)
                                <div class="col-md-3">
                                    <h4>Tên Phòng, Ban, Khoa,... (Chủ trì)</h4>
                                ...
                                <div class="col-md-4">
                                    <h4>Tên Phòng, Ban, Khoa,... (Phối hợp)</h4>
                                    <div id="selection-treeview" style="overflow: auto; height: 500px">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <h4>Phòng, Ban, Khoa,... được chọn</h4>
                                    <div id="checked-items" style="overflow: auto; height: 500px; width: 300px;"></div>
                                </div>
                            @else
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <h4>Phòng, Ban, Khoa,... được chọn</h4>
                                    <div id="checked-items" style="overflow: auto; height: 500px"></div>
                                </div>
                            @endif
                        </div>
                    </div>
    ...
    <script>
        ...
        $('.btn-add').click(function () {
            ...
            var users =  $("input[name='users[]']").map(function (){
                return $(this).val()
            }).get();
            $("input[name='user_chutri_ids[]']:checked").map(function (){
                users.push($(this).val())
                return $(this).val()
            }).get();
            var error = true;
            ...
            if (!error){
                jAlert('Không thể chọn 1 người vừa chủ trì, vừa phối hợp', 'Thông báo')
                return false;
            }
            $('#xulyvanban').submit();
        });
