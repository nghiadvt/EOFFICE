<div class="col-md-7 wrapper-left-content">
	...
	<div class="table-responsive" id="congviec_table">
		@if( sizeof($congviecs) > 0 )
			@include(config('app.interface').'vanbandonvi._table_congviec')
		@else
	...
	<div class="tab-content" id="list-content">
		<div id="detail-tab" class="tab-pane fade in active">
			<div class="container-work-detali">
				@include(config('app.interface').'vanbandonvi.chitiet')
			</div>
		</div>
		<div id="document-tab" class="tab-pane fade">
			@include(config('app.interface').'vanbandonvi.tailieu')
		</div>
		<div id="discuss-tab" class="tab-pane fade">
			@include(config('app.interface').'vanbandonvi.thaoluan')
		</div>
		<div id="report-tab" class="tab-pane fade">
			@include(config('app.interface').'vanbandonvi.baocao')
		</div>
		<div id="participant" class="tab-pane fade">
			@include(config('app.interface').'vanbandonvi.nguoithamgia')
		</div>
		
	</div>
</div>
@include(config('app.interface').'vanbandonvi.them-cv', ['vanbanxuly' => isset($vanbanxuly)? $vanbanxuly : null])
@include(config('app.interface').'vanbandonvi.capnhat_cv')
<script>
