	...
	<div class="row">
		<div class="col-md-6">
			@if ( sizeof($check_CheckUser) != 0 ) 
	  			@include(config('app.interface').'congviecs._viewWork.colum_1')
			@else
				@include(config('app.interface').'congviecs._viewWork.colum_2')
			@endif
	    </div>
	    <div class="col-md-6">
	  		@if ( sizeof($check_CheckUser) != 0 ) 
	  			@include(config('app.interface').'congviecs.fullcalendar',["inc_calendar"=>"inc_calendar"])
			@else
				@include(config('app.interface').'congviecs._viewWork.colum_1')
			@endif
	    </div>
