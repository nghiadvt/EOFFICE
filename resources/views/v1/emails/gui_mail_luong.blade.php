    ...
    <div class="tablescroll-scroll dragscroll dragscroll-tb tb-end ">
        <table border="1" width="50%" style="border-collapse:collapse;margin-left:auto; margin-right:auto;font-family:'Times New Roman', serif;font-variant:normal;font-size: 1rem;">
            ...
            <tr>
                ...
                <th scope="row" style="text-align: left;font-weight: 100;height: 40px">Lương họp đồng</th>
                <td colspan="2" style="text-align: right;font-weight: 700">{{number_format($data['luong_hop_dong'],0,',',',')}} đ</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align: center;background: #ed7d31">17</td>
    ...
    <div class="tablescroll-scroll dragscroll dragscroll-tb tb-end ">
            ...
            <table class="table table-bordered table-striped txt-center" border="1" width="100%" style="border-collapse:collapse;text-align: center; width: 50%; margin-left:auto; margin-right:auto;font-family:'Times New Roman', serif;font-variant:normal;font-size: 1rem;">
                ...
                <tr>
                    ...
                    <th scope="row" style="text-align: left;font-weight: 100;height: 40px;font-size: 1rem;">Lương hợp đồng</th>
                    <td colspan="2" style="text-align: right;font-weight: 700">{{number_format($data['luong_hop_dong'],0,',',',')}} đ</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <th scope="row" style="text-align: left;font-weight: 100;height: 40px">Tiền thưởng</th>
                    <td colspan="2" style="text-align: right;font-weight: 700">{{number_format($data['tienthuong'],0,',',',')}} đ</td>
                </tr>
                <tr>
                    <th scope="row" style="text-align: center;font-weight: 100;">10</th>
                    <th scope="row" style="text-align: left;font-weight: 100;height: 40px">Thu nhập tăng thêm</th>
                    <td colspan="2" style="text-align: right;font-weight: 700">{{number_format($data['thunhap_tangthem'],0,',',',')}} đ</td>
                </tr>
                <tr>
                    <th scope="row" style="text-align: center;font-weight: 100;">11</th>
                    <th scope="row" style="text-align: left;font-weight: 100;height: 40px">Truy lĩnh LTT, QLP, 1,5T Lương tết</th>
                    <td colspan="2" style="text-align: right;font-weight: 700">{{number_format($data['truy_linh_ltt_qlp'],0,',',',')}} đ</td>
                </tr>
                <tr>
