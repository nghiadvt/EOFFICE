        ...
        <div class="col-sm-12">
            <form id="TaikhoanForm" action="{{ route('save_tai_khoan') }}" class="form-input" method="POST">
                <div class="form-row">
                    ...
                    <div class="col-md-12 vanban" style="display: {{$user->role == 3 ? '' : 'none'}}" id="lichtuan_lanhdao">
                        <div class="form-item">
                            <div class="form-item-l">
                            ...
                            <div class="form-item-c">
                                ...
                                {{-- <input type="checkbox" name="lanhdao" {{ ($user->lanhdao? 'checked' : '') }} style="margin-top: 10px;"> --}}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-item">
                            ...
                            <div class="row form-item-c" style="display: flex ; margin-top: -9px">
                                ...
                                <div class="col-md-12 vanban">
                                    <div class="form-item">
                                        <div class="form-item-c">
                                            <input type="checkbox" name="congviec {{ ($user->congviec? 'checked' : '') }}" style="margin-top: 10px; ">
                                        </div>
                                        <div class="form-item-l">
