...
{{--                                        </div>--}}
                                        <div class="col-md-10">
                                            <div class="custom-control custom-radio">
                                                ...
                                                <label class="custom-control-label" for="check2" >Danh sách tổng hợp thu nhập thuế</label>
                                            </div>
        ...
        <div class="tablescroll tb-parent">
            ...
            <div class="tablescroll-scroll dragscroll dragscroll-tb tb-end">
                <table class="table table-bordered table-striped txt-center">
                    ...
                    <tr>
                        <th class="text-center" colspan="12">Các khoản tính thuế</th>
                    ...
                    <tr>
                        ...
                        <th class="w-nowrap">Lương hợp đồng</th>
                        ...
                        <th class="w-nowrap">Tiền thưởng</th>
                        <th class="w-nowrap">Thu nhập tăng thêm</th>
                        <th class="w-nowrap">Truy lĩnh LTT, QLP, 1,5T Lương tết</th>
                    ...
                    <tr class="w-nowrap">
                        ...
                        <td>{{number_format($users->luong_hop_dong,0,',',',')}}</td>
                        ...
                        <td>{{number_format($users->tienthuong,0,',',',')}}</td>
                        <td>{{number_format($users->thunhap_tangthem,0,',',',')}}</td>
                        <td>{{number_format($users->truy_linh_ltt_qlp,0,',',',')}}</td>
            ...
            <div class="tablescroll-scroll dragscroll dragscroll-tb tb-end">
                <table class="table table-bordered table-striped txt-center">
                    ...
                    <tr>
                        ...
                        <th class="w-nowrap text-center" rowspan="2">Lương hợp đồng</th>
