                                ...
                                @foreach($users as $user)
                                    <tr class="even pointer">
                                        @if(strlen($user->macanbo) == '' )
                                            ...
                                            <td style="color: red ;text-align: left;">{{$user->luong_hop_dong}}</td>
                                            ...
                                            <td style="color: red">{{$user->tienthuong}}</td>
                                            <td style="color: red">{{$user->thunhap_tangthem}}</td>
                                            <td style="color: red">{{$user->truy_linh_ltt_qlp}}</td>
                                        ...
                                        @else
                                            ...
                                            <td style="text-align: left;">{{$user->luong_hop_dong}}</td>
                                            ...
                                            <td>{{$user->tienthuong}}</td>
                                            <td>{{$user->thunhap_tangthem}}</td>
                                            <td>{{$user->truy_linh_ltt_qlp}}</td>
                                ...
                                <div class="data-contaner">
                                    ...
                                    @foreach($users as $index => $user)
                                            <input class="user" type="hidden"  data-date="{{ $date }}" data-fullname="{{ $user->fullname }}"
                                                   ...
                                                   data-luong_hop_dong="{{ $user->luong_hop_dong }}"
                                                   ...
                                                   data-tienthuong="{{ $user->tienthuong }}"
                                                   data-thunhap_tangthem="{{ $user->thunhap_tangthem }}"
                                                   data-truy_linh_ltt_qlp="{{ $user->truy_linh_ltt_qlp }}"
    ...
    <script>
        ...
        function process(index, total) {
            ...
            $.post(url, {
                ...
                luong_hop_dong: itemUser.data('luong_hop_dong'),
                ...
                tienthuong: itemUser.data('tienthuong'),
                thunhap_tangthem: itemUser.data('thunhap_tangthem'),
                tong_cackhoan_tinhthue: itemUser.data('tong_cackhoan_tinhthue'),
                truy_linh_ltt_qlp: itemUser.data('truy_linh_ltt_qlp'),
