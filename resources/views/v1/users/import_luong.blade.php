...
<div class="container-fuild pdt20">
    <div class="row">
        ...
        <div class="col-sm-6" style="padding: 0px; margin-left: 25%">
            <p class="col-sm-6"><button style="text-align:center" onclick="showImportExcell_4()" type="button" class="btn btn-primary btn-block"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Import excel thanh toán lương và phụ cấp</button></p>
            <p class="col-sm-6"><button style="text-align:center" onclick="showImportExcell()" type="button" class="btn btn-primary btn-block"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Import excel tổng hợp thu nhập</button></p>
        </div>
                ...
                <form id="ImportExcell" action="{{url('import_update_thu_thue')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div style="margin-top: 20px;">
                        <label>{{trans('common.str_select_file_excel')}}
                            <a href={{url('app/webroot/phpexcel/mau/mau_thu_nhap_thue_new.xlsx')}} target="_blank" title="Click để dowload mẫu" style="color: blue">mẫu tại đây</a>
                        </label>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="ImportExcell_4" action="{{url('import_update_luong_phu_cap')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div style="margin-top: 20px;">
                            <label>{{trans('common.str_select_file_excel')}}
                                <a href={{url('app/webroot/phpexcel/mau/mau_thanhtoan_phucap_tienluong_new.xlsx')}} target="_blank" title="Click để dowload mẫu" style="color: blue">mẫu tại đây</a>
                            </label>
                        </div>
                        <div style="margin-top: 15px">
