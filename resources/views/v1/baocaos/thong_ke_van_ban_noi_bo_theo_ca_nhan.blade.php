...
<div class="container container-list report-statistic">
    ...
    <div class="row">
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a href="{{ route('baocaothongke.vbnoibocanhan') }}">Theo cá nhân</a></li>
            <li><a href="{{ route('baocaothongke.vbnoibodonvi') }}">Theo đơn vị</a></li>
        </ul>
        <br>
...
<script type="text/javascript">
    ...
    $('.ds-bao-cao').click(function(event) {
        ...
        $.getJSON('{{ route("baocaothongke.vbnoibodanhsach") }}', {user_id: user_id, type: type, start_time: start_time, end_time: end_time}, function(json, textStatus) {
            loading_hide();
    ...
    function xuatWord() {
        let url = "<?php echo e(route('baocaothongke.vbnoibocanhan')); ?>";
