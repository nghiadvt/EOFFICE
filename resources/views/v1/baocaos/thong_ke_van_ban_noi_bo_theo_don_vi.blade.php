...
<div class="container container-list report-statistic">
    ...
    <div class="row">
        ...
        <ul class="nav nav-tabs">
            <li><a href="{{ route('baocaothongke.vbnoibocanhan') }}">Theo cá nhân</a></li>
            <li class="active"><a href="{{ route('baocaothongke.vbnoibodonvi') }}">Theo đơn vị</a></li>
        </ul>
        <br>
...
<script type="text/javascript">
    ...
    function xuatWord() {
        let url = "<?php echo e(route('baocaothongke.vbnoibodonvi')); ?>";
