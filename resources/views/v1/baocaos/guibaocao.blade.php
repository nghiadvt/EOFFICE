        ...
        @if(!sizeof($checkreport))
             <div class="filter-page col-md-8 col-sm-8 form-group">
                ...
                {!! Form::textarea('content',null,array('id'=>'content_editor','class' => 'form-control pull-left', 'placeholder' => "Nhập nội dung")) !!}
                    <div id="load" class="loading" style="display:none; position:fixed; top:0; left:0; right:0; bottom:0; justify-content:center; align-items:center"><img src="img/loadinggraphic.gif"/></div>
                </div>
...
function send() {
        jConfirm('{!! 'Bạn có muốn gửi báo cáo?' !!}', '{!! 'Thông báo' !!}', function(r) {
            if(r){
                document.getElementById("load").style.display = "flex";  // show the loading message.
