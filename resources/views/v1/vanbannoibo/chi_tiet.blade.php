                    ...
                    <div class="row">
                        ...
                        <div class="pull-right btn-custom" style="display: flex">
                            ...
                            @if ($vanbanden->user_id == session('user')['id'])
                                <a class=" btn btn-primary mg-l10" href="{{ url('vanbannoibo/sua', $vanbanden->id) }}" title="Sửa văn bản"><i class="fa fa-eraser" aria-hidden="true"> Sửa văn bản</i></a>
                            ...
                            @endif
                            <a class=" btn btn-primary mg-l10" href="{{ url('vanbannoibo/chuyen-xu-ly', $vanbanden->id) }}" title="Chuyển xử lý văn bản"><i class="fa fa-paper-plane-o" aria-hidden="true"> Chuyển xử lý văn bản</i></a>
